...
```gradle
dependencies {
    implementation platform('com.github.violet000.NewLandPlugins:newland-bom:1.1.2')
...
```gradle
dependencies {
    implementation 'com.github.violet000.NewLandPlugins:newland-all:1.1.2'
    // 紫金 / Chainway（原 Cordova 插件）：
    // implementation 'com.github.violet000.NewLandPlugins:zijin-all:1.1.2'
}
```
...
```gradle
implementation 'com.github.violet000.NewLandPlugins:zijin-uhf:1.1.2'
implementation 'com.github.violet000.NewLandPlugins:zijin-scan:1.1.2'
implementation 'com.github.violet000.NewLandPlugins:zijin-fingerprint:1.1.2'
implementation 'com.github.violet000.NewLandPlugins:usb-camera:1.1.2'
```
